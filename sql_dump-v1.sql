...
INSERT INTO `clients` VALUES (1,'Tudor','Campului 42, Cluj-Napoca, Romania','tudorgiu@gmail.com',20),(2,'Dudu','Campului 42, Cluj-Napoca, Romania','vlad@gmail.com',19),(3,'Alex','Campului 42, Cluj-Napoca, Romania','alexdx@yahoo.com',20),(4,'Andrei','Izlazului 33, Cluj-Napoca, Romania','ondrash2@gmail.com',20),(5,'Catalin','Sincai 12, Baia Mare, Romania','catalin.g@gmail.com',49),(6,'Florica','Nucilor 2, Baia Mare, Romania','florica.rodica@gmail.com',60),(7,'Laurentiu','Calea Motilor 7, Cluj-Napoca, Romania','laur.office@gmail.com',42),(8,'Ovi','Grigo','ovi@gmail.com',43),(9,'Andrei','Cluj','andrei@gmail.com',20);
...
CREATE TABLE `log` (
  ...
  CONSTRAINT `order_id_fk` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `log` VALUES (1,400),(2,8000),(3,270.6),(4,2000),(5,260),(6,500),(7,320.99),(8,320.99),(9,260),(10,100),(11,3209.9);
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_id_foreignk_idx` (`product_id`),
  KEY `client_id_foreignk` (`client_id`),
  CONSTRAINT `client_id_foreignk` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`),
  CONSTRAINT `product_id_foreignk` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,1,1,1),(2,4,2,2),(3,7,6,3),(4,5,3,1),(5,5,8,1),(6,3,4,10),(7,2,5,1),(8,5,5,1),(9,1,8,1),(10,9,11,2),(11,9,5,10);
...
INSERT INTO `products` VALUES (1,'Tastatura Gaming',400,99),(2,'Iphone 14 Pro',4000,18),(3,'Monitor LG 144Hz',2000,4),(4,'Key switch x 4',50,190),(5,'Mouse Logitech',320.99,38),(6,'Banda Led MIXEL',90.2,297),(7,'Banda Led RGBoss',180,21),(8,'Incarcator Samsung Wireless',260,43),(9,'Casti Bluetooth Sony',700,4),(10,'Cablu USB-USBC',34,50),(11,'Ghiozdan',50,198);
...
-- Dump completed on 2023-12-11 11:45:45
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-05-17 21:49:46',NULL),('diagnostics.include_raw','OFF','2023-05-17 21:49:46',NULL),('ps_thread_trx_info.max_length','65535','2023-05-17 21:49:46',NULL),('statement_performance_analyzer.limit','100','2023-05-17 21:49:46',NULL),('statement_performance_analyzer.view',NULL,'2023-05-17 21:49:46',NULL),('statement_truncate_len','64','2023-05-17 21:49:46',NULL);
...
-- Dump completed on 2023-12-11 11:45:46
...
CREATE TABLE `order_details` (
  `order_jd` int NOT NULL,
  `ticket_id` int NOT NULL,
  `amount` int DEFAULT NULL,
  PRIMARY KEY (`order_jd`,`ticket_id`),
  KEY `external_ticket_id_idx` (`ticket_id`),
  KEY `external_ticket_id_idxx` (`ticket_id`) /*!80000 INVISIBLE */,
  CONSTRAINT `external_ticket_id2` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Tudor','Giuroiu','tudorgiu@gmail.com',21,'mata',0),(2,'Horea','Haragis','horea@federal.com',21,'federal202',0),(3,'Mihai','Ratiu','ratiu@gmail.ro',21,'parola',0),(4,'Mihai','Ratiu','ratiu@gmail.ro',21,'parola',0);
